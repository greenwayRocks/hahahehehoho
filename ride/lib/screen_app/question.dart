...
class Quiz{
  ...
  var questions = [
    ...
    "_________ is the biggest mountain of nepal.",
    "what eats up everything but dies when given water to drink",
    "A nocturnal animal with some really big eyes",
  ];


  var choices = [
    ["krishna", "K.P. oli", "hari", "sakar"],
    ["Manaslu", "everest", "annapurna", "machhapuchhre"],
    ["love", "hate", "fight", "fire"],
    ["Spider", "Snake", "Hawk", "Owl"]
  ];


  var correctAnswers = [
    "K.P. oli", "everest", "fire", "Owl"
  ];
}
